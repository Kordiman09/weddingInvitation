...
const Hero = () => {
  return (
    ...
    >
      ...
      <h1 className="text-xs font-parisienne text-white lg:mb-24 md:mb-1 sm:mb-24">
          .
      </h1>

      {/* Fixed height for h1 with responsive font size */}
      <h1 
        className="text-6xl md:text-8xl lg:text-9xl font-parisienne text-white lg:mt-1 md: sm:mt-2 mb-7" 
        style={{ height: 'auto' }}
      >
        Ryan & Alicia
      </h1>
